...
public class DatePickerFragment extends DialogFragment {
    ...
    public static final String EXTRA_DATE =
            "com.example.denmr.notes.date_picker_date";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDatePicker = (DatePicker) v.findViewById(R.id.alert_date_Picker);
    ...
    // Send result of date picker on OK button click overridden in onCreateDialog()
